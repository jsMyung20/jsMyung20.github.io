...
import { loadTexture } from '../util/texture.js';  // texture file load funciton
...
function render() {
    ...
    gl.enable(gl.DEPTH_TEST);  // 3D -> depth test 필요
...
async function main() {
    try {
        ...
        // activate the texture unit 0 (-> 16)
        ...
        // pass the u_texture uniform veriable to the shader
